    ...
    IDataShaper<EmployeeDto> dataShaper) : IEmployeeService
{
        ...
        EmployeeParameters employeeParameters, bool trackChanges)
    {
        ...
        var employeesWithMetaData =
            await repository.EmployeeRepository.GetEmployeesAsync(companyId, employeeParameters, trackChanges);
    ...
    public async Task<ExpandoObject> GetEmployeeAsync(Guid companyId, Guid employeeId, bool trackChanges,
