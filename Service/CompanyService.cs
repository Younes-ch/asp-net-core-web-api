    ...
    IMapper mapper) : ICompanyService
{
    ...
    {
        var companiesMetaData =
            await repository.CompanyRepository.GetAllCompaniesAsync(companyParameters, trackChanges);
        ...
        IEnumerable<CreateCompanyDto> companyCollection)
    {
        ...
        foreach (var company in companyEntities) repository.CompanyRepository.CreateCompany(company);
